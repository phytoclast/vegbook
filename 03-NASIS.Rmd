...
*3)	Total Stand Attributes*
  ...
  * b)	Plant Aggregate Attributes (derived from stand composition data)
    ...
    * v)	Stand Total Tree Canopy Cover
    * vi)	Stand Total Shrub Canopy Cover
    * vii)	Stand Total Herb Canopy Cover
    * viii)	Stand Total Nonvascular Cover
    * ix)	Stand Total Vegetation Canopy Cover (Inverse Canopy Gap)
    * x)	Stand Leaf Area Index (total foliar cover of all strata)
    * xi)	Stand Total Stand Biomass (aboveground/belowground)
    * xii)	Stand Productivity
    * xiii)	Stand Age
