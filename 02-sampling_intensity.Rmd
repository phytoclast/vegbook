...
* 1. **Vegetation Plot**
  ...
  * a. **Plot Plant Inventory**: Maximum height by species, and bottoms for trees (dominant)
    ...
    * a1. Subplot Plant Details
      * Subplot Number (serial)
      * Subplot Size (m²)
      * Number of Stems (count)
      * Average Stem Diameter (cm --> inch; actual measurement not important if represented as diameter or height class in parent table)
  * b. **Plot Species Basal Area**:  
    * Plant (USDA Plants Symbol)
    * Plant Type Group
    * Plant Nativity
