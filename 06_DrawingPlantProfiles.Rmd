...
Many parameters can be adjusted such as making the plot longer or changing sky color. Add unknown deciduous shrub with glaucus green leaves by specifying  habit code "S.BD" and crown fill color finding a the rgb color code that looks right.
